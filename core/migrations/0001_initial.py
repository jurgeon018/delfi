# Generated by Django 2.2.7 on 2019-11-12 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered', models.BooleanField(default=False, verbose_name='Оформлен до конца')),
                ('pdf', models.FileField(blank=True, null=True, upload_to='pdfs/', verbose_name='Билет')),
                ('preordered', models.BooleanField(default=False, verbose_name='Должна ли поступить оплата?')),
                ('created', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, null=True, verbose_name='Обновлен')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderated', models.BooleanField(default=False, verbose_name='Опубликован')),
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='core.Post', verbose_name='Пост')),
            ],
            options={
